  ...
  return (
    <div style={pageStyle}>
      ...
      >
        ...
        <p style={subtitleStyle}>Join us and start your journey today!</p>
        ...
        <form onSubmit={handleSubmit} style={formStyle}>
          ...
          <button
            ...
            style={{
              ...
              transform: success ? "scale(0.98)" : "scale(1)",
            }}
          >
            Sign Up
          </button>

          {error && <p style={messageStyle("#f87171")}>{error}</p>}
          {success && <p style={messageStyle("#4ade80")}>{success}</p>}
        </form>
